                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      borderTop: isActive ? "1px solid var(--color-primary)" : "1px solid var(--color-border)",
                      borderLeft: isActive ? "1px solid var(--color-primary)" : "1px solid var(--color-border)",
                      borderRight: isActive ? "1px solid var(--color-primary)" : "1px solid var(--color-border)",
                      borderBottom: "none",
