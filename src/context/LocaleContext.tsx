...
export const dictionaries: Record<string, Record<string, string>> = {
  id: {
    ...
    value_title_highlight: "PT. Karya Sistem Teknologi",
    value_subtitle: "Komitmen pengadaan hardware bergaransi resmi, integrasi sistem profesional, dan ketersediaan stok perangkat IT enterprise.",
    val_1_title: "100% Garansi Resmi",
    val_1_tagline: "Distributor & Reseller Resmi",
    val_1_desc: "Seluruh unit server, networking, laptop bisnis, dan lisensi software dijamin 100% original bergaransi resmi dari principal terkemuka.",
    val_1_stat_label: "Original Guarantee",

    val_2_title: "Respon Teknis Fast SLA",
    val_2_tagline: "Konsultasi & Dukungan Ahli",
    val_2_desc: "Tim sales dan technical engineer berpengalaman siap memberikan solusi arsitektur IT dan penawaran terbaik dalam waktu singkat.",
    val_2_stat_label: "Response Time",

    val_3_title: "Pre-Deployment Staging",
    val_3_tagline: "Siap Pakai & Teruji",
  ...
  en: {
    ...
    value_title_highlight: "PT. Karya Sistem Teknologi",
    value_subtitle: "Our commitment to official warranty hardware procurement, professional system integration, and enterprise IT availability.",
    val_1_title: "100% Official Warranty",
    val_1_tagline: "Authorized Distributor & Partner",
    val_1_desc: "Every server unit, networking hardware, business laptop, and software license is 100% genuine with official manufacturer warranty.",
    val_1_stat_label: "Original Guarantee",

    val_2_title: "Fast Response Technical SLA",
    val_2_tagline: "Expert Consultation & Support",
    val_2_desc: "Experienced sales and technical engineers ready to provide custom IT architecture proposals and support within minutes.",
    val_2_stat_label: "Response Time",
