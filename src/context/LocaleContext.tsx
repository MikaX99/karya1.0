...
export const dictionaries: Record<string, Record<string, string>> = {
  id: {
    ...
    client_stat_1: "Klien Enterprise",
    client_stat_2: "Sektor Industri",
    client_stat_3: "Kota di Indonesia",
  ...
  en: {
    ...
    client_stat_1: "Enterprise Clients",
    client_stat_2: "Industry Sectors",
    client_stat_3: "Cities in Indonesia",
